...
// Import Flathead-specific apparel data from centralized JSON
import apparelProductsData from '@/data/apparel-products.json'

export default function FlatheadLakePage() {
   ...
   * Data
   * --------------------------------------------------*/
  // Flathead-specific accessories
  const flatheadAccessories = [
    {
      id: 'beanie-flathead',
  ...
  const flatheadProducts = apparelProductsData.filter((product: any) =>
    product.lake === 'FLATHEAD' || product.name.toLowerCase().includes('flathead')
  )

  const allFlatheadProducts = [...flatheadProducts, ...flatheadAccessories]

  const lakeInfo = {
    name: 'Flathead Lake',
    description: 'Montana',
    heroImage: '/images/FLATHEAD.svg',
    headerBackgroundImage: '/images/FLATHEAD.svg',
  ...
  const webcamConfig = {
    ...
    title: 'Flathead Lake Live Webcam',
  }
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Unified LakePageTemplate */}
        <LakePageTemplate
          lakeInfo={lakeInfo}
          apparelProducts={allFlatheadProducts}
